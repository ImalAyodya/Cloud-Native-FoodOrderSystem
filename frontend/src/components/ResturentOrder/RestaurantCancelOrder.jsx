...
const RestaurantCancelOrder = ({ 
  ...
  const handleCancelOrder = async () => {
    ...
    try {
      // Use the orderStatusController's cancelOrder endpoint
      const response = await fetch(`http://localhost:5001/api/orders/cancel/${orderId}`, {
        ...
        body: JSON.stringify({ 
          reason: finalReason,
          cancelledBy: 'restaurant', // Important: this identifies who cancelled the order
          additionalInfo: cancelReason === 'Other' ? 'Custom reason provided by restaurant' : 'Selected from common restaurant reasons'
        }),
      });
                  ...
                  <div className="flex items-start gap-4 mb-6">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 text-sm">
                        Cancelling this order will notify the customer and refund any payments made. This action cannot be undone.
                      </p>
                    </div>
                  </div>
...
export default RestaurantCancelOrder;